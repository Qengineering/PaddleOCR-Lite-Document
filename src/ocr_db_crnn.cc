...
//
// Modified by Q-engineering 2023/04/07
//
...
void system(char **argv){
  ...
  for (int i = 0; i < cv_all_img_names.size(); ++i) {
    ...
    std::cout << "det_time_info[0] " << det_time_info[0] <<  std::endl;
    std::cout << "det_time_info[1] " << det_time_info[1] <<  std::endl;
    std::cout << "det_time_info[2] " << det_time_info[2] <<  std::endl;
    std::cout << "rec_time_info[0] " << rec_time_info[0] <<  std::endl;
    std::cout << "rec_time_info[1] " << rec_time_info[1] <<  std::endl;
    std::cout << "rec_time_info[2] " << rec_time_info[2] <<  std::endl;
